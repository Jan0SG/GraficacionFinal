...
namespace LIVE_DEMO
{
    public partial class MAIN_FORM : Form
    {
        ...
        public MAIN_FORM()
        {
            ...
            //TB_Trans_X.Cursor = Cursors.NoMoveHoriz;
        ...
        private void BTN_EXE_Click(object sender, EventArgs e)
        {
            ...
            if(animate == true)
            BTN_EXE.BackColor = Color.Green;

            if(animate == false)
            BTN_EXE.BackColor = Color.Maroon;
        }
        ...
        private void button2_Click(object sender, EventArgs e)
        {
           ...
           // CB_TRANSLATE.Checked = false;
            ...
            transform = 3;
            T_X.Text = "Scaling";
            T_Y.Text = "Sorry not available";
            T_Z.Text = "Sorry not available";
